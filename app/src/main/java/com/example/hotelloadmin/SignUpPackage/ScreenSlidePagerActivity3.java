...
public class ScreenSlidePagerActivity3 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new ScreenSlidePagerActivity3.ScreenSlidePagerAdapter(getSupportFragmentManager());
