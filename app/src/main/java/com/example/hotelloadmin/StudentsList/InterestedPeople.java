...
public class InterestedPeople extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Log.e("MMR",""+InterestedCount);
        ...
        toolbar.setTitleTextColor(ContextCompat.getColor(InterestedPeople.this,R.color.black));
    ...
    public void fetch(){
        ...
        eventsReference.child(NewsFeedKey).child("Interested").addChildEventListener(cel);
    ...
    protected void onDestroy() {
        eventsReference.child(NewsFeedKey).child("Interested").removeEventListener(cel);
        super.onDestroy();
    }
        ...
        public void onBindViewHolder(@NonNull InterestedPeople.MyAdapter.MyViewHolder holder, int i) {
            ...
            holder.UserName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent=new Intent(InterestedPeople.this, PeopleClick.class);
